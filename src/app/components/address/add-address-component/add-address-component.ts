...
export class AddAddressComponent implements OnInit {
  ...
  constructor(private custService : CustomerService, private addressService : AddressService, private router :Router){}
  ...
  addAddress(){
    this.addressService.addAddress(this.addressForm.value as IAddress).subscribe({
      next:()=>{
